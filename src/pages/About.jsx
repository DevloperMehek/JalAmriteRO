...
import AdityaImg from "../MyImg/AdityaImg.png";
...
const About = () => {
  ...
  <section className="bg-water-grad pt-14 pb-12 lg:pt-20 lg:pb-16 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <p className="mt-3 text-xl lg:text-2xl text-slate-700 max-w-2xl font-medium">
        {t("about_lead")}
      </p>
    </div>
  </section>
      ...
      <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden shadow-2xl ring-1 ring-slate-200">
        ...
        <div className="absolute bottom-5 left-5 right-5 bg-white/90 backdrop-blur rounded-2xl p-5 shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display font-bold text-[#0B3B60]">
                Mr. Aditya Gupta
              </div>

              <div className="text-xs text-slate-500">
                Founder · Jal Amrit RO Sales & Service
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        >
          {STATS.map((s) => (
            <div
              key={s.label}
              className="bg-[#F4F9FF] rounded-2xl p-5 border border-slate-100"
            >
              <div className="font-display text-3xl font-extrabold text-[#0B3B60]">
                {s.value}
              </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8">
    <div
      className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-100 lift-on-hover"
    ...
    >
      ...
      <h3 className="font-display text-2xl font-extrabold mt-6 text-[#0B3B60]">
        {t("our_mission")}
      </h3>
...
<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
  <div className="bg-gradient-to-br from-[#0B3B60] via-[#0B3B60] to-[#00A3E0] rounded-[2rem] p-10 lg:p-16 text-center text-white relative overflow-hidden">
    ...
    <h3 className="font-display text-3xl lg:text-4xl font-extrabold">
      Become part of the Jal Amrit family
    </h3>

    <p className="mt-3 text-blue-100/90 max-w-2xl mx-auto">
      Free site visit, transparent pricing, lifetime support. Get your RO
      today.
    </p>

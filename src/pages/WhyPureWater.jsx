...
const HEALTH_RISKS = [
  {
    ...
    text: "Cholera, Typhoid, Hepatitis A — caused by bacteria & viruses in untreated water.",
  },
  {
    icon: Brain,
    title: "Heavy Metal Toxicity",
    text: "Lead, arsenic & mercury cause neurological damage and developmental issues in children.",
  },
  {
    icon: Bone,
    title: "Bone & Kidney Problems",
    text: "High TDS, fluoride and hard water lead to kidney stones and weak bones over time.",
  },
  {
    icon: Activity,
    title: "Digestive Disorders",
    text: "Contaminated water triggers IBS, ulcers and chronic diarrhoea.",
  },
];
...
const RO_PARTS = [
  {
    ...
    desc: "Removes mud, sand, dust & visible particles. First layer of defence.",
  },
  {
    icon: Filter,
    name: "Pre-Activated Carbon",
    desc: "Absorbs chlorine, pesticides, smells & bad taste from water.",
  },
  {
    icon: Zap,
    name: "RO Membrane",
    desc: "0.0001 micron filter — removes 99.9% TDS, heavy metals, bacteria.",
  },
  {
    icon: Sparkles,
    name: "UV Lamp",
    desc: "Kills any remaining viruses, bacteria & cysts.",
  },
  {
    icon: TestTube,
    name: "UF Membrane",
    desc: "Ultra-Filter blocks micro-organisms; works without electricity too.",
  },
  {
    icon: Heart,
    name: "Mineral / Copper Cartridge",
    desc: "Adds back essential minerals (Ca, Mg) and copper for taste & health.",
  },
];
    ...
    <div data-testid="why-pure-water-page">
      <section className="bg-water-grad pt-14 pb-12 lg:pt-20 lg:pb-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-xs font-bold uppercase tracking-[0.25em] text-[#00A3E0]">
            Knowledge Centre
          </div>

          <h1 className="mt-3 font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0B3B60]">
            {t("why_water_title")}
          </h1>

          <p className="mt-3 text-lg text-slate-600 max-w-2xl">
            {t("why_water_subtitle")}
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#F4F9FF] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-xs font-bold uppercase tracking-[0.25em] text-[#FF7A00]">
            Risks of Impure Water
          </div>

          <h2 className="mt-2 font-display text-3xl sm:text-4xl font-extrabold text-[#0B3B60]">
            What's hiding in your tap water?
          </h2>

          <div
            className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5"
            data-testid="health-risks-grid"
          >
            {HEALTH_RISKS.map((r, i) => (
              <div
                key={i}
                className="bg-white p-7 rounded-3xl border border-slate-100 lift-on-hover"
                data-testid={`health-risk-${i}`}
              >
                ...
                <h3 className="font-display text-lg font-bold mt-5 text-[#0B3B60]">
                  {r.title}
                </h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <p className="text-slate-600 mt-2 max-w-2xl">
          Every Jal Amrit RO is engineered to deliver pure, safe and tasty water
          through multiple stages.
        </p>

        <div
          className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"
          data-testid="ro-parts-grid"
        >
          {RO_PARTS.map((p, i) => (
            <div
              key={i}
              className="relative bg-white p-7 rounded-3xl border border-slate-200 lift-on-hover"
              data-testid={`ro-part-${i}`}
            >
      ...
      <section className="bg-[#F4F9FF] py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className=" ml-1 text-xs font-bold uppercase tracking-[0.25em] text-[#00A3E0]">
            FAQ
          </div>

          <h2 className="mt-2 mb-4 font-display text-3xl sm:text-4xl font-extrabold text-[#0B3B60]">
          ...
          >
            {FAQS.map((f, i) => (
              ...
              >
                <AccordionTrigger
                  value={`faq-${i}`}
                  className="font-display font-bold text-left text-[#0B3B60] hover:no-underline"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-br from-[#FF7A00] to-rose-600 rounded-[2rem] p-10 lg:p-14 text-white text-center relative overflow-hidden">
          <Droplet
            size={70}
            className="absolute top-6 right-6 opacity-15 animate-float"
          />

          <h3 className="font-display text-3xl lg:text-4xl font-extrabold">
            Test your water — Free at home
          </h3>

          <p className="mt-3 max-w-2xl mx-auto text-orange-50">
            Our team comes to your doorstep with a TDS meter, hardness kit & expert
            advice. Zero charges. Zero obligations.
          </p>

...
const HeroCarousel = ({ offers }) => {
  ...
  return (
    <div
      ...
      data-testid="hero-offers-carousel"
    >
      <div className="relative aspect-square rounded-[2rem] overflow-hidden shadow-2xl ring-1 ring-white/30">
        {offers.map((o, i) => (
          ...
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br ${o.color}`}
            />
            ...
            <div className="relative h-full flex flex-col justify-between p-7 text-white">
              ...
              <div>
                ...
                <Button
                  onClick={() =>
                    openBooking(lang === "hi" ? o.title_hi : o.title_en)
                  }
                  className="mt-5  text-[#0B3B60] hover:bg-white/90 rounded-full px-6 h-11 font-bold shadow-lg"
...
const Home = () => {
  ...
  const featured = [
    ...PRODUCTS.domestic_branded.slice(0, 2),
    ...PRODUCTS.domestic_assembled.slice(0, 1),
    ...PRODUCTS.commercial_assembled.slice(0, 1),
  ];
    ...
    <div data-testid="home-page">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link to="/products" data-testid="hero-explore-products-link">
                  <Button
                    variant="outline"
                    className="rounded-full h-12 px-7 font-bold text-base border-2 border-[#0B3B60] text-[#0B3B60] hover:bg-[#0B3B60] "
                  >
              ...
              <div className="mt-10 flex flex-wrap items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span><b className="text-[#0B3B60]">5,000+</b> happy families</span>
                </div>

                <div className="flex items-center gap-2">
                  <Star size={18} className="text-yellow-500 fill-yellow-500" />
                  <span><b className="text-[#0B3B60]">4.9</b> Google rating</span>
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B3B60]">
            {t("why_choose_us")}
          </h2>
        </div>
        ...
        >
          {whyItems.map((it, i) => {
            ...
            return (
              <div
                key={i}
                className="lift-on-hover bg-white p-7 rounded-3xl border border-slate-100"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0B3B60]">
                {t("featured_products")}
              </h2>
            ...
            <Link to="/products" data-testid="home-view-all-products">
              <Button
                variant="outline"
                className="rounded-full border-2 border-[#0B3B60] text-[#0B3B60] hover:bg-[#0B3B60] hover:text-white font-semibold"
              >
        ...
        >
          {SERVICES.slice(0, 6).map((s) => {
            ...
            return (
              <div
                key={s.id}
                className="lift-on-hover relative p-7 bg-white rounded-3xl border border-slate-200"
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between">
                  <span className="font-display font-extrabold text-xl text-[#FF7A00]">
                    {s.price}
                  </span>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <p className="mt-3 text-blue-100/90 text-lg">
              {t("cta_strip_subtitle")}
            </p>
          </div>

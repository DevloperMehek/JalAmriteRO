    ...
    <div data-testid="services-page">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="font-display text-2xl sm:text-3xl font-extrabold text-[#0B3B60]">
            {t("active_offers")}
          </h2>
        </div>
        ...
        <div
          ...
          data-testid="services-active-offers"
        >
          {OFFERS.map((o) => (
            <div
              key={o.id}
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="font-display text-xl font-extrabold leading-tight drop-shadow-md">
          ...
          >
            {SERVICES.map((s) => {
              ...
              return (
                <div
                  key={s.id}
                  className="lift-on-hover relative bg-white rounded-3xl border border-slate-200 p-7"
                ...
                >
                  ...
                  <h3 className="font-display text-xl font-bold mt-5 text-[#0B3B60]">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    <span className="font-display text-xl font-extrabold text-[#FF7A00]">
                      {s.price}
                    </span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-[#0B3B60]">
          RO Types We Service
        </h2>

        <p className="text-slate-600 mt-2 max-w-xl">
          All major brands and our own Jal Amrit assembled ROs starting at ₹4,999.
        </p>
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={b}
              className="bg-white border border-slate-200 rounded-2xl p-6 text-center font-display font-bold text-[#0B3B60] hover:border-[#00A3E0] transition lift-on-hover"
              data-testid={`brand-tile-${b.replace(/\s+/g, "-").toLowerCase()}`}
            >
              {b}
            </div>
          ))}

...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-[#0B3B60] text-white pt-16 pb-8 mt-12"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-5 text-blue-100/80 leading-relaxed text-sm max-w-xs">
              {t("footer_about")}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-blue-100/90">
              <li>
                <Link to="/" className="hover:text-[#00A3E0]">
                  {t("nav_home")}
                </Link>
              </li>
              <li>
                <Link to="/products" className="hover:text-[#00A3E0]">
                  {t("nav_products")}
                </Link>
              </li>
              <li>
                <Link to="/services" className="hover:text-[#00A3E0]">
                  {t("nav_services")}
                </Link>
              </li>
              <li>
                <Link to="/why-pure-water" className="hover:text-[#00A3E0]">
                  {t("nav_why")}
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-[#00A3E0]">
                  {t("nav_about")}
                </Link>
              </li>
            </ul>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-display text-sm uppercase font-bold text-white/70 mb-5">
              {t("footer_contact")}
            </h4>
          ...
          <div>
            ...
            <Button
              onClick={() => openBooking()}
              className="bg-[#FF7A00] hover:bg-[#E66E00] w-full rounded-full"
            >
            ...
            <a
              href={`tel:${CONTACT.phoneIntl}`}
              className="mt-3 inline-flex w-full items-center justify-center gap-2 px-7 h-11 rounded-full bg-white/10 hover:bg-white/15"
            >
              <Phone size={16} />
              {t("call_now")}
            </a>
        ...
        <div className="border-t border-white/10 mt-14 pt-6 text-xs text-blue-100/60 flex justify-between">
          <p>
            © {new Date().getFullYear()} {t("brand_full")}. {t("footer_rights")}
          </p>

          <p className="flex items-center gap-1">
            {t("footer_made")} <Heart size={12} className="text-rose-400" />{" "}
            {t("footer_in_bhopal")}
          </p>
        </div>
      </div>

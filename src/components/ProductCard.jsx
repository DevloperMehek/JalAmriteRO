...
const ProductCard = ({ p }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="p-5">
        <div className="text-[11px] uppercase tracking-[0.2em] font-bold text-[#00A3E0] mb-1">
          {p.brand}
        </div>

        <h3 className="font-display text-lg font-bold text-[#0B3B60] line-clamp-1">
          {p.name}
        </h3>
        ...
        <div className="mt-4 flex items-end justify-between">
          <div>
            <div className="flex items-baseline gap-2">
              <span className="font-display text-2xl font-extrabold text-[#0B3B60]">

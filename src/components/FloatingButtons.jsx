...
const FloatingButtons = () => {
  return (
    <div
      className="fixed right-4 sm:right-6 bottom-4 sm:bottom-6 z-50 flex flex-col gap-3"
      data-testid="floating-cta-buttons"
    >
      <a
        href={`https://wa.me/${CONTACT.whatsappIntl}?text=${encodeURIComponent(
          "Hello Jal Amrit, I want to enquire about RO."
        )}`}
        target="_blank"
        rel="noreferrer"
      ...
      >
        <span
          className="absolute inset-0 rounded-full animate-ripple bg-[#25D366]/40"
          aria-hidden
        />
